...
- 其次是网站的评论管理系统，~~在<a href="http://duoshuo.com/">多说</a>(点击我要安装)上注册账号，设置域名。比如我的是www.fullmark.duoshuo.com。fullmark（后面会用到）~~ 多说已挂！现本网站使用的是Valine评论系统，详情参考：<a href="https://valine.js.org/#/">https://valine.js.org/#/</a>
...
修改为你自己的域名，如：```fullmark.github.io```如果没有直接清空(后面访问时,直接访问自己的github page即可）
...
当同步完成后，在浏览器输入你的域名，比如我的是：```fullmark.github.io```，然后就能看到你的博客了。任何人都可以看到哦。   
...
由于我也是个菜鸟新手。所以如果大家有什么问题的话，可以留言，也可以email（fanghuanbiao@foxmail.com）我，请教谈不上，大家一起探讨。
